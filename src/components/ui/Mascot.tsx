import { MascotCode } from "./MascotCode"
import { MascotEngineer } from "./MascotEngineer"
import { MascotWorkOut } from "./MascotWorkOut"
import { MascotBook } from "./MascotBook"
import { MascotTea as MascotTeaDetailed } from "./MascotTea"

type Pose = "working" | "reading" | "studying" | "tea" | "teadetailed" | "code" | "engineer" | "workout" | "book"
...
function MascotWorking({ className = "", size = 120 }: { className?: string; size?: number }) {
  return (
...
function MascotReading({ className = "", size = 120 }: { className?: string; size?: number }) {
  return (
    <svg viewBox="0 0 120 120" width={size} height={size} className={className} fill="none">
      <ellipse cx="60" cy="95" rx="32" ry="22" fill="var(--color-ink)" />
      <circle cx="60" cy="50" r="22" fill="var(--color-ink)" />
...
function MascotStudying({ className = "", size = 120 }: { className?: string; size?: number }) {
  return (
    <svg viewBox="0 0 120 120" width={size} height={size} className={className} fill="none">
      <ellipse cx="60" cy="95" rx="32" ry="22" fill="var(--color-ink)" />
      <circle cx="60" cy="50" r="22" fill="var(--color-ink)" />
...
function MascotTea({ className = "", size = 120 }: { className?: string; size?: number }) {
  return (
    <svg viewBox="0 0 120 120" width={size} height={size} className={className} fill="none">
      <ellipse cx="60" cy="95" rx="32" ry="22" fill="var(--color-ink)" />
      <circle cx="60" cy="50" r="22" fill="var(--color-ink)" />
...
export function Mascot({ className = "", size = 120, pose = "working" }: MascotProps) {
  switch (pose) {
    case "working":
      return <MascotWorking size={size} className={className} />
    case "reading":
      return <MascotReading size={size} className={className} />
    case "studying":
      return <MascotStudying size={size} className={className} />
    case "tea":
      return <MascotTea size={size} className={className} />
    case "teadetailed":
      return <MascotTeaDetailed size={size} className={className} />
    case "code":
      return <MascotCode size={size} className={className} />
    case "engineer":
      return <MascotEngineer size={size} className={className} />
    case "workout":
      return <MascotWorkOut size={size} className={className} />
    case "book":
      return <MascotBook size={size} className={className} />
    default:
      return <MascotWorking size={size} className={className} />
  }
}
