        ...
        <ScrollReveal>
          <div className="glass rounded-3xl p-8 md:p-10">
            <div className="flex flex-col md:flex-row gap-8 items-start mb-8">
              <div className="w-24 h-24 rounded-2xl overflow-hidden border-2 border-[var(--color-accent)]/30 flex-shrink-0">
              ...
              <div>
                <h2 className="text-3xl md:text-4xl font-serif font-bold mb-2">Hey, I'm <span className="text-[var(--color-accent)]">a friend you haven't met yet</span></h2>
            ...
            <div className="mt-8 pt-8 border-t border-[var(--color-border)]">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {funFacts.slice(0, 6).map((f) => (
                  <div key={f.id} className="flex items-center gap-2 text-sm text-[var(--color-text-secondary)] font-light">
                    <span>{f.fact}</span>
                  </div>
                ))}
              </div>
